module.exports = {
  ...
  '@arkecosystem/core-database-postgres': {
    connection: {
      ...
      database: process.env.ARK_DB_DATABASE || `kapu_${process.env.ARK_NETWORK_NAME}`,
  ...
  '@arkecosystem/core-p2p': {
    ...
    port: process.env.ARK_P2P_PORT || 4600,
  ...
  '@arkecosystem/core-api': {
    ...
    port: process.env.ARK_API_PORT || 4601,
    whitelist: ['*']
  },
  '@arkecosystem/core-webhooks': {
    ...
    server: {
      ...
      port: process.env.ARK_WEBHOOKS_PORT || 4602,
      whitelist: ['127.0.0.1', '::ffff:127.0.0.1', '192.168.*']
    }
  },
  '@arkecosystem/core-graphql': {
    ...
    port: process.env.ARK_GRAPHQL_PORT || 4603,
    path: '/graphql',
    graphiql: true
  },
